        ...
        <div class="container">
            <div class="tracking_box_inner">
                ...
                <form class="row tracking_form" action="<?=PROOT?>orders/trackbyid" method="post" novalidate="novalidate">
                    ...
                    <div class="col-md-12 form-group">
                        <input type="email" class="form-control" id="cardnumber" name="cardnumber" placeholder="Card Number used for this order" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Card Number used for this order '">
                    </div>
                    <div class="col-md-12 form-group">
